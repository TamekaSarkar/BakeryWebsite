...
function createproductlist() {
    ...
    for (i = productlist.length; i <= 100; i++) {
        var newproduct = new product("<img class=\"productimg\" src=\"img/cookies.PNG\">", "p" + id, "Auto name" + i, "Auto description" + i, Math.floor((Math.random() * 50) + 1), Math.floor((Math.random() * 100) + 1), supplierlist[Math.floor(Math.random() * supplierlist.length)]);
