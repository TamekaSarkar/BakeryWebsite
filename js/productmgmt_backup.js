...
function renderproductlist() {
   ...
   if (currentUser.role == "supplierAdmin" || currentUser.role == "supplierUser" ) {
    ...
    //Choose Supplier
    var chooseSupplier = "<option selected>Choose Supplier...</option>";
    if (currentUser.role == "superAdmin") {
        chooseSupplier += "<option>Cake n Bake</option>";
        chooseSupplier += "<option>Three Brothers Bakery</option>";
        chooseSupplier += "<option>Kroger Bakery</option>";
        chooseSupplier += "<option>Macrina Bakery</option>";
        chooseSupplier += "<option>Pearl Bakery</option>";
        chooseSupplier += "<option>Arandas Bakery</option>";
    }
    else if (currentUser.role == "supplierAdmin" || currentUser.role == "supplierUser") {
        chooseSupplier += "<option>" + currentUser.company + "</option>";
    }
    document.getElementById("psupplier").innerHTML = chooseSupplier;
    document.getElementById("editpsupplier").innerHTML = chooseSupplier;
}
