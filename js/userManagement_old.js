...
/*function renderuserlist() {
    ...
    for (var i = 0; i < userlist.length; i++) {
        ...
        if (currentUser.role == "superAdmin" || (currentUser.role == "buyerAdmin") || (currentUser.role == "supplierAdmin") ) {
            ...
            //delete 
            userRow = userRow + "<td><input id=\"user_delete\" class=\"delete\" type=\"button\" value=\"delete\" onclick=\"deleteitem(" + i + ");\" /></td></tr>";
        }
    }
    document.getElementById("usertable").innerHTML = "<table max_rows=10 id=\"UserTable\">" + userRow + "</table>";
...
/*function renderuserlist() {
    ...
    if (currentUser.role == "supplierUser") {
        for (var i = 0; i < userlist.length; i++) {
            if (currentUser.role == userlist[i].role && currentUser.company == userlist[i].company) {
                var rownum = "row" + i + 1;
                userRow += "<tr id=\"rownum\"><td id= \"Username\" >" + userlist[i].userName + "</td>";
                userRow += "<td id= \"Firstname\">" + userlist[i].firstName + "</td>";
                userRow += "<td id= \"Lastname\">" + userlist[i].lastName + "</td>";
        ...
        for (var i = 0; i < userlist.length; i++) {
            if (currentUser.role == userlist[i].role && currentUser.company == userlist[i].company) {
                ...
                userRow += "<td id = \"Phone\">" + userlist[i].phone + "</td>";
                userRow += "<td id = \"Role\">" + userlist[i].role + "</td>";
                userRow += "<td id = \"Company\">" + userlist[i].company + "</td></tr>";
            }
        }
    }
    else {
        for (var i = 0; i < userlist.length; i++) {
            ...
            else if (((currentUser.role == "buyerAdmin") || (currentUser.role == "supplierAdmin")) && (userlist[i].company == currentUser.company)) {
                //edit button
                userRow += "<td><input class=\"edit\" id=\"edit_button\" type=\"button\" value=\"edit\" data-toggle=\"modal\" data-target=\"#editUser\" onclick =\"prefilluser(" + i + ")\";/></td>";
                //delete 
                userRow += "<td><input id=\"user_delete\" class=\"delete\" type=\"button\" value=\"delete\" onclick=\"deleteitem(" + i + ");\" /></td></tr>";
...
function renderuserlist() {
    ...
    if (currentUser.role == "supplierUser" || currentUser.role == "buyerUser") {
        for (var i = 0; i < userlist.length; i++) {
            if (currentUser.company == userlist[i].company) {
                var rownum = "row" + i + 1;
                userRow += "<tr id=\"rownum\"><td id= \"Username\" >" + userlist[i].userName + "</td>";
                userRow += "<td id= \"Firstname\">" + userlist[i].firstName + "</td>";
                userRow += "<td id= \"Lastname\">" + userlist[i].lastName + "</td>";
    ...
    function rendertablelist(searchindex) {
        ...
        for (var i = 0; i < userlist.length; i++) {
            if (i == searchindex[index]) {
                ...
                userRow += "<td><input class=\"edit\" id=\"edit_button\" type=\"button\" value=\"edit\" data-toggle=\"modal\" data-target=\"#editUser\"/></td>";
                //delete 
                userRow += "<td><input id=\"user_delete\" class=\"delete\" type=\"button\" value=\"delete\" onclick=\"deleteitem(this)\" /></td></tr>";
            }
        }
        document.getElementById("usertable").innerHTML = "<table id=\"UserTable\">" + userRow + "</table>";
    }
